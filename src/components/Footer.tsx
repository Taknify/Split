    ...
    <footer className="bg-gray-900 text-white mt-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="pt-12 pb-8 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">SplitApp</h3>
            <p className="text-gray-400 mb-4">The easiest way to split bills with friends and family. Create virtual cards, scan receipts, and settle up without the hassle.</p>
        ...
        <div className="py-6 border-t border-gray-800 text-center text-sm text-gray-400">
          <p>&copy; {currentYear} SplitApp. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
