...
export default function AdminPage() {
  ...
  const realUsers = [
    { id: '1', name: 'Admin User', email: 'adharbhattarai@gmail.com', role: 'Admin', createdAt: '2023-07-01', groups: 2, isAdmin: true },
    { id: '2', name: 'Regular User', email: 'user@example.com', role: 'User', createdAt: '2023-07-02', groups: 1, isAdmin: false },
  ];
